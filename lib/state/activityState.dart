...
class ActivityState extends AppState {
  ...
  List<ActivityModel>? get activitylist {
    // return a mock list of activities
    return [
      ActivityModel(name: "Biking"),
      ActivityModel(name: "Movie"),
      ActivityModel(name: "Hike"),
      ActivityModel(name: "Mountain Biking"),
      ActivityModel(name: "Mountain Mike's Pizza"),
      ActivityModel(name: "Smoothie Shop"),
      ActivityModel(name: "House Hangout"),
      ActivityModel(name: "Pizza party at my place"),
      ActivityModel(name: "Ping Pong"),
      ActivityModel(name: "Tennis"),
      ActivityModel(name: "Golf"),
      ActivityModel(name: "Soccer"),
      ActivityModel(name: "Baseball"),
      ActivityModel(name: "Basketball"),
      ActivityModel(name: "Beach Volleyball"),
    ];
  }
